"""Tabulated critical dip values and p-value interpolation.

=============================================================================
 LICENSE NOTICE -- this file is GPLv3, NOT the license of the rest of this
 project.
=============================================================================
This module is vendored verbatim (unchanged, aside from this notice) from
the `diptest` PyPI package (https://github.com/RUrlus/diptest,
diptest/consts.py), which is licensed under the GNU General Public
License v3.0 (GPLv3). It is distributed here under the same license. See
https://www.gnu.org/licenses/gpl-3.0.html for the full license text. This
GPLv3 obligation applies only to this file and common/dip_test.py (its
companion dip-statistic implementation) -- it does not extend to the rest
of this project.

Original source and copyright:
    diptest -- https://github.com/RUrlus/diptest
    Copyright (c) R. Urlus and contributors, 2022-2023. GPLv3.

This module has no compiled/binary dependency (pure NumPy lookup table +
linear interpolation), so unlike the compiled `_diptest_core` extension
it vendors cleanly into a marimo WASM/Pyodide export.

Reference for the tabulated critical values:
